...
<div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        ...
        <div class="loginmodal-container">
          ...
          <div class="login-help">
            <a href="#" data-toggle="modal" data-target="#signup-modal"><h5>Register</h5></a> - <a href="#"><h5>Forgot Password</h5></a>
          </div>
        </div>
    </div>
</div>
...
>
        ...
        <form>
        <input type="text" name="user" placeholder="Create Username" required="required">
        <input type="text" name="name" placeholder="Your Name" required="required">
        <input type="text" name="address" placeholder="Address" required="required">
        <input type="submit" name="Next" class="login loginmodal-submit" data-toggle="modal" data-target="#next" value="Next ->">
        </form>
    </div>
    </div>
    </div>
    <div class="modal fade" id="next" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            ...
            <div class="loginmodal-container">
              ...
              <form>
                    <input type="text" name="Aadhar" placeholder="Aadhar card no./Pan no." required="required">
                     <input type="radio" name="idver" required="required">Aadhar card no<br>   
                    <input type="radio" name="idver" required="required" >Pan no.<br><br>
                    <input type="email" name="Email" placeholder="Email address" required="required">
                    <input type="date" name="Birthday" placeholder="Enter your birthday" required="required">
                    <input type="password" name="pass" placeholder="Create a Password" required="required">
